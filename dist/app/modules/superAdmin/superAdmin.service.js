...
const updateProfile = (authUserId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updateSuperAdmin = yield superAdmin_model_1.default.findByIdAndUpdate(updatedUser.superAdmin, { $set: payload }, { new: true, session });
        if (!(updateSuperAdmin === null || updateSuperAdmin === void 0 ? void 0 : updateSuperAdmin._id)) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to update profile!');
        }
    ...
    if (result) {
        result = yield superAdmin_model_1.default.findById(result.id);
    }
    return result;
});
